...
<template>
  ...
  <v-card class="page-card my-7">
    ...
    <v-row class="mt-3">       
      <v-col cols="3">
        Font Color
        <p class="text--secondary text-sm-caption mb-0">Color of text in this readout widget</p>
      </v-col>
      <v-col cols="9">
        <v-row dense>
          <v-col cols="6">
            <color-picker v-model="fontColor" class="color-picker" label="Color"></color-picker>
          </v-col>
        </v-row>
      </v-col>
    </v-row>
