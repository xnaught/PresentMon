...
#define METRIC_LIST(X_) \
		...
		\
		X_(PM_METRIC_PROCESS_NAME, PM_METRIC_TYPE_STATIC, PM_UNIT_DIMENSIONLESS, PM_DATA_TYPE_STRING, PM_DATA_TYPE_STRING, 0, PM_DEVICE_TYPE_INDEPENDENT, PM_STAT_MID_POINT) \
...
#define PREFERRED_UNIT_LIST(X_) \
		...
		X_(PM_METRIC_CPU_WAIT_TIME, PM_UNIT_MICROSECONDS)
