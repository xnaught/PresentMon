...
#define METRIC_LIST(X_) \
		...
		X_(PM_METRIC_GPU_MEM_SIZE, PM_METRIC_TYPE_DYNAMIC, PM_UNIT_BYTES, PM_DATA_TYPE_DOUBLE, 0, PM_DEVICE_TYPE_GRAPHICS_ADAPTER, FULL_STATS) \
		...
		X_(PM_METRIC_GPU_MEM_MAX_BANDWIDTH, PM_METRIC_TYPE_DYNAMIC, PM_UNIT_BPS, PM_DATA_TYPE_DOUBLE, 0, PM_DEVICE_TYPE_GRAPHICS_ADAPTER, FULL_STATS) \
