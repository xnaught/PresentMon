...
#define METRIC_LIST(X_) \
		...
		X_(PM_METRIC_CPU_FRAME_QPC, PM_METRIC_TYPE_DYNAMIC_FRAME, PM_UNIT_QPC, PM_DATA_TYPE_UINT64, PM_DATA_TYPE_UINT64, 0, PM_DEVICE_TYPE_INDEPENDENT, PM_STAT_MID_POINT) \
