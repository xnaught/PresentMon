...
extern "C" {
	...
	enum PM_METRIC
	{
		...
		// PM_METRIC_FRAME_TIME, // need a better definition of this
		PM_METRIC_FRAME_DURATION,
		PM_METRIC_GPU_BUSY_TIME,
		PM_METRIC_GPU_WAIT_TIME,
		PM_METRIC_DISPLAY_DURATION,
		PM_METRIC_DROPPED_FRAMES,
		PM_METRIC_NUM_FRAMES,
		...
		PM_METRIC_VRAM_POWER,
		PM_METRIC_VRAM_VOLTAGE,
		PM_METRIC_VRAM_FREQUENCY,
		PM_METRIC_VRAM_EFFECTIVE_FREQUENCY,
		PM_METRIC_VRAM_TEMPERATURE,
		...
		PM_METRIC_VRAM_POWER_LIMITED,
		PM_METRIC_VRAM_TEMPERATURE_LIMITED,
		PM_METRIC_VRAM_CURRENT_LIMITED,
		PM_METRIC_VRAM_VOLTAGE_LIMITED,
		PM_METRIC_VRAM_UTILIZATION_LIMITED,
		...
		PM_METRIC_TIME, // maybe overlaps with PM_METRIC_FRAME_TIME
		PM_METRIC_TIME_IN_PRESENT_API,
		PM_METRIC_TIME_BETWEEN_PRESENTS,
		PM_METRIC_TIME_UNTIL_RENDER_COMPLETE,
		PM_METRIC_TIME_UNTIL_DISPLAYED,
		PM_METRIC_TIME_BETWEEN_DISPLAY_CHANGE,
		PM_METRIC_TIME_UNTIL_RENDER_START,
		PM_METRIC_TIME_SINCE_INPUT,
		PM_METRIC_GPU_VIDEO_BUSY_TIME,

		PM_METRIC_CPU_DURATION,
		PM_METRIC_CPU_FRAME_PACING_STALL,
		PM_METRIC_GPU_DURATION,
	};
