...
extern "C" {
	...
	enum PM_METRIC
	{
		...
		PM_METRIC_INSTRUMENTED_RENDER_LATENCY,
		PM_METRIC_INSTRUMENTED_SLEEP,
		PM_METRIC_INSTRUMENTED_GPU_LATENCY,
		// PM_METRIC_INSTRUMENTED_RENDER_DISPLAY_LATENCY, Disabled for now
	};
