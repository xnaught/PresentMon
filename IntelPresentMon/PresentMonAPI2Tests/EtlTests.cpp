...
namespace EtlTests
{
	...
	public:
		...
		TEST_METHOD(Tc9v2W3DriverLLOn8220Ext)
		{
			namespace bp = boost::process;
			using namespace std::string_literals;
			using namespace std::chrono_literals;

			const uint32_t processId = 8220;
			const std::string processName = "witcher3.exe";
		...
		TEST_METHOD(Tc10v2MPcLatency4632Ext)
		{
			namespace bp = boost::process;
			using namespace std::string_literals;
			using namespace std::chrono_literals;

			const uint32_t processId = 4632;
