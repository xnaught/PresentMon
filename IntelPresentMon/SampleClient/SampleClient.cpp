...
void PollMetrics(uint32_t processId, double metricsOffset)
{
    ...
    PM_QUERY_ELEMENT elements[]{
        ...
        PM_QUERY_ELEMENT{.metric = PM_METRIC_CPU_WAIT_TIME, .stat = PM_STAT_MID_POINT, .deviceId = 0, .arrayIndex = 0},
        ...
        PM_QUERY_ELEMENT{.metric = PM_METRIC_CPU_BUSY_TIME, .stat = PM_STAT_MID_POINT, .deviceId = 0, .arrayIndex = 0},
        ...
        PM_QUERY_ELEMENT{.metric = PM_METRIC_PRESENT_QPC, .stat = PM_STAT_MID_POINT, .deviceId = 0, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_PRESENT_SYNC_INTERVAL, .stat = PM_STAT_MID_POINT, .deviceId = 0, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_NUM_PRESENTS, .stat = PM_STAT_MID_POINT, .deviceId = 0, .arrayIndex = 0},
