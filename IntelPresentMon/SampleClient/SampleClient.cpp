...
void PollMetrics(uint32_t processId, double metricsOffset)
{
    ...
    */
    ...
    PM_QUERY_ELEMENT elements[]{
        ...
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_UTILIZATION, .stat = PM_STAT_PERCENTILE_90, .deviceId = 1, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_UTILIZATION, .stat = PM_STAT_PERCENTILE_95, .deviceId = 1, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_UTILIZATION, .stat = PM_STAT_PERCENTILE_99, .deviceId = 1, .arrayIndex = 0},
        ...
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_VENDOR, .stat = PM_STAT_RAW, .deviceId = 1, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_NAME, .stat = PM_STAT_RAW, .deviceId = 1, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_MEM_MAX_BANDWIDTH, .stat = PM_STAT_RAW, .deviceId = 1, .arrayIndex = 0},
        PM_QUERY_ELEMENT{.metric = PM_METRIC_GPU_MEM_SIZE, .stat = PM_STAT_RAW, .deviceId = 1, .arrayIndex = 0},
    };
