...
namespace GfxLayer
{
    ...
    {
    public:
    	ID3D11Device_Wrapper(REFIID riid, IUnknown* pObject): IUnknown_Wrapper(riid, pObject)
        {}
        ...
        virtual HRESULT STDMETHODCALLTYPE CheckCounter(const D3D11_COUNTER_DESC* pDesc, D3D11_COUNTER_TYPE* pType, UINT* pActiveCounters, char* szName, UINT* pNameLength, char* szUnits, UINT* pUnitsLength, char* szDescription, UINT* pDescriptionLength);
